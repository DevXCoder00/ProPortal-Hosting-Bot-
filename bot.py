...
TOKEN = os.getenv('TOKEN', '8230705293:AAFjzDQO38JyXu3mQe72VGAnm3CdMxNGQeo')
...
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'Kon_Hu_Mai')
...
def _logic_help(message):
    help_text = """
🤖 **Dev Coder Hosting Bot Help Guide**
...
if __name__ == '__main__':
    logger.info("="*50 + "\n🤖 Dev Coder Hosting Bot Starting Up...\n" + f"🐍 Python: {sys.version.split()[0]}\n" +
